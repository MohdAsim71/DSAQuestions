...
fun hasLoop(head: com.example.dsaquestions.questions.linkedlist.Node?): Boolean {
    if (head?.next == null) {
        return false
    }

    var slow: com.example.dsaquestions.questions.linkedlist.Node? = head
    var fast: com.example.dsaquestions.questions.linkedlist.Node? = head
