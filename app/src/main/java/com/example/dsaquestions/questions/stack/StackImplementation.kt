package com.example.dsaquestions.questions.stack

class Node<T>(var data: T) {
    var next: com.example.dsaquestions.questions.stack.Node<T>? = null
}

class Stack<T> {
    private var top: com.example.dsaquestions.questions.stack.Node<T>? = null
