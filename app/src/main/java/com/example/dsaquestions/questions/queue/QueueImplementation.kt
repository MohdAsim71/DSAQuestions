package com.example.dsaquestions.questions.queue

class QueueNode<T>(var data: T) {
    var next: com.example.dsaquestions.questions.queue.QueueNode<T>? = null
}

class Queue<T> {
    private var front: com.example.dsaquestions.questions.queue.QueueNode<T>? = null
    private var rear: com.example.dsaquestions.questions.queue.QueueNode<T>? = null
